    ...
    elements.forEach((element) => {
        switch (element.type) {
          ...
          transform="rotate(${element.rotation} ${
                    element.position.x + (element.dimensions?.width || 0) / 2
                } ${
                    element.position.y + (element.dimensions?.height || 0) / 2
                })"\
        />`;
                break;
        ...
        >${element.content}</text>`;
            ...
            case "hexagon": {
                ...
                if (hexRadius > 0) {
                    ...
                    for (let i = 0; i < 6; i++) {
                        ...
                        const px =
                            element.position.x + hexRadius * Math.cos(angle);
                        const py =
                            element.position.y + hexRadius * Math.sin(angle);
            ...
            case "pentagon": {
                ...
                if (pentRadius > 0) {
                    ...
                    for (let i = 0; i < 5; i++) {
                        ...
                        const px =
                            element.position.x + pentRadius * Math.cos(angle);
                        const py =
                            element.position.y + pentRadius * Math.sin(angle);
          ...
          />`;
            ...
            case "octagonStar": {
                ...
                if (starRadius > 0) {
                    ...
                    for (let i = 0; i < 16; i++) {
                        const currentRadius =
                            i % 2 === 0 ? starRadius : starRadius * 0.4;
          ...
          />`;
            ...
            case "blockArrow": {
                ...
                if (points.length > 0) {
                    ...
                    const pointsStr = absolutePoints
                        .map((p) => `${p.x},${p.y}`)
                        .join(" ");
          ...
          />`;
            ...
            stroke-width="${element.styles.strokeWidth}" 
            opacity="${element.styles.opacity}" 
            transform="translate(${element.position.x} ${
                        element.position.y
