...
const ElementProperties: React.FC<ElementPropertiesProps> = ({
        ...
        return (
            <div className="element-properties">
                ...
                <div className="property-group locked-element-group">
                    ...
                    <p className="locked-element-message">
                        This element is currently locked. Unlock it to edit its
                        properties.
                    </p>
                    ...
                    <div className="locked-properties-preview">
                        <div className="locked-property">
                            <span>Position:</span> x: {element.position.x}, y:{" "}
                            {element.position.y}
                        </div>
                        {element.dimensions && (
                            <div className="locked-property">
                                <span>Size:</span> {element.dimensions.width} ×{" "}
    ...
    const handleTextChange = (
        field: "content" | "fontFamily" | "fontSize",
        value: string | number
    ) => {
            ...
            <div className="property-group">
                            ...
                            <div className="color-picker-popover">
                                ...
                                <SketchPicker
                                    ...
                                    onChange={(color: ColorResult) =>
                                        handleChange("styles.fill", color.hex)
                                    }
                                />
                            </div>
                        )}
                        ...
                        {showStrokePicker && (
                            <div className="color-picker-popover">
                                ...
                                <SketchPicker
                                    ...
                                    onChange={(color: ColorResult) =>
                                        handleChange("styles.stroke", color.hex)
                                    }
                                />
                            </div>
                        )}
                ...
                <div className="property-row">
                    ...
                    <span className="range-value">
                        {element.styles.opacity.toFixed(1)}
                    </span>
                </div>
            </div>
                ...
                <div className="property-group">
                    ...
                    <div className="property-row">
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                handleTextChange("fontSize", e.target.value)
                            }
                        />
                    </div>
                </div>
