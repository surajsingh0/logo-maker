    ...
    return (
        <div className="toolbar">
            <div className="toolbar-section">
                ...
                <div
                    className={`toolbar-buttons ${
                        collapsedSections.shapes ? "collapsed" : ""
                    }`}
                >
                    <button
            ...
            <div className="toolbar-section">
                ...
                <div
                    className={`toolbar-buttons ${
                        collapsedSections.text ? "collapsed" : ""
                    }`}
                >
                    <button
                        className="toolbar-button"
            ...
            <div className="toolbar-section">
                ...
                >
                    Arrange
                    <span className="collapse-icon">
                        {collapsedSections.arrange ? "▸" : "▾"}
                    </span>
                </h3>
                <div
                    className={`toolbar-buttons ${
                        collapsedSections.arrange ? "collapsed" : ""
                    }`}
                >
                    <button
                        className="toolbar-button"
                        ...
                        disabled={
                            !hasSelection || areSomeSelectedElementsLocked
                        }
            ...
            <div className="toolbar-section">
                ...
                <div
                    className={`toolbar-buttons ${
                        collapsedSections.actions ? "collapsed" : ""
                    }`}
                >
                    <button
                        className="toolbar-button"
            ...
            <div className="toolbar-section">
                ...
                <div
                    className={`toolbar-buttons ${
                        collapsedSections.export ? "collapsed" : ""
                    }`}
                >
                    <button
